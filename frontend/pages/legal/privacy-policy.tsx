...
const PrivacyPolicyPage: NextPage = () => {
  return (
    <PublicSimpleContentLayout title="Privacy Policy">
      <Paragraph>
        <p>
          Your privacy is important to us. It is Easy Assets&apos; policy to respect your privacy
          regarding any information we may collect from you across our website,{' '}
          <a href="https://easyassets.com.au">https://easyassets.com.au</a>, and other sites we own
          and operate.
        </p>
        <p>
        ...
        <p>
          We don’t share any personally identifying information publicly, except when required to by
          law. We only share your contact details with our listed companies upon requesting a quote.
        </p>
        <p>
